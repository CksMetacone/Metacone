...
public class SpeechRecognition : MonoBehaviour
{
    ...
    public Button chatGptSendButton;
    public bool isMicOk;

    public Animator animator;
    //public GameObject OrtakVeri;
    ...
    private string Result_Recognized= "";
    ...
    private void RecognizedHandler(object sender, SpeechRecognitionEventArgs e)
    {
        ...
        if (e.Result.Reason == ResultReason.RecognizedSpeech)
        {
            ...
            lock (threadLocker)
            {
                ...
                Result_Recognized = $"{e.Result.Text}";
...
#region Speech Translation event handlers
    ...
    void Update()
    {
        ...
        lock (threadLocker)
        {
            if (Result_Recognized.Length > 0 && !isMicOk)
            {
                Debug.Log("Aralık");
                RecognizedText.text = Result_Recognized;//recognizedString;
                ErrorText.text = errorString;
                
                chatGptSendButton.onClick.Invoke();
                isMicOk = true;

                animator.SetTrigger("Happys");
                Debug.Log("Ani:Happys");
