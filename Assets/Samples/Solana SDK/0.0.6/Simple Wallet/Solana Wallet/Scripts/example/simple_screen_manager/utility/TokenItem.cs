...
namespace Solana.Unity.SDK.Example
{
    public class TokenItem : MonoBehaviour
    {
        ...
        public GameObject charaterGo;
        public GameObject walletPart;
        public CharScript charScript;

        private void Awake()
        {
            logo = GetComponentInChildren<RawImage>();
            walletPart = GameObject.Find("--Wallet--");
            charaterGo = GameObject.Find("--Char--");
            charScript = FindObjectOfType<CharScript>();
        }
        ...
        public void CharacterGet()
        {
            charaterGo.SetActive(true);
            walletPart.SetActive(false);
            charScript.StartObjects();
        }
